package com.minehut.warzone.util.bossBar;
...
public class LocalizedBossBar {
    ...
    public String getTitle(String locale) {
        return bossBarTitle.getMessage(locale);
    }

    public void setTitle(ChatMessage message) {
        this.bossBarTitle = message;
        for (Player player : playerBossBars.keySet()) {
            playerBossBars.get(player).setTitle(bossBarTitle.getMessage(player.getLocale()));
        }
    }

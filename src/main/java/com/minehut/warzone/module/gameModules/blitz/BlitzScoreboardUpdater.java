 ...
 */
public class BlitzScoreboardUpdater implements ScoreboardUpdater {
    ...
    public void initialSetup(TeamModule teamModule, SimpleScoreboard simpleScoreboard) {
        ...
        simpleScoreboard.setTitle(ChatColor.AQUA + "Players Remaining");
    ...
    private String getTeamScoreString(TeamModule teamModule) {
        return ChatColor.WHITE.toString() + teamModule.size() + " " + teamModule.getColor() + teamModule.getName();
    }

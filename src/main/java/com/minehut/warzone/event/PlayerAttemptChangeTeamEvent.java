...
public class PlayerAttemptChangeTeamEvent extends Event implements Cancellable {
    ...
    public PlayerAttemptChangeTeamEvent(Player player, Optional<TeamModule> newTeam, Optional<TeamModule> oldTeam) {
        this.player = player;
